      ...
      <div className={styles.item1}>
        ...
        <table border="1" className={styles.Table1}>
          ...
          <tbody>
            <tr>
              <td>
                <input type="text" size={25} value={training_name} onChange={(e) => setTraining_name(e.target.value)} className={styles.input} />
              </td>
              <td>
                <input type="text" size={3} value={weight} onChange={(e) => setWeight(e.target.value)} className={styles.input} /> [kg]
              </td>
              <td>
                <input type="text" size={2} value={count} onChange={(e) => setCount(e.target.value)} className={styles.input} /> ［回］
              </td>
              <td>
                <input type="text" size={2} value={set} onChange={(e) => setSet(e.target.value)} className={styles.input} />［セット］
              </td>
            </tr>
          </tbody>
        </table>
